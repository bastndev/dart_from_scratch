...
void main() async {
  final file = File('zz/serialization.txt');
  final country = Country(nameEN: 'Andorra', nameES: 'Andorra', iso: 'AD');
  final countries = [country, Country(nameEN: 'Perú', nameES: 'Peru', iso: 'PE')];

  String str = await file.readAsString();

  final decodedCountries = jsonDecode(str);

  print(decodedCountries.map((e) => Country.fromJson(e)).toList()); 

  file.writeAsString(jsonEncode(countries));
}
